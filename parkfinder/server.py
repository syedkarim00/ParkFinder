...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            if not locations:
                raise ValueError("Add at least one Ontario Parks result URL, resourceLocationId, or preset park.")
            ...
            self.send_json({"weekends": [w.__dict__ for w in weekends], "results": result_dicts(results)})
